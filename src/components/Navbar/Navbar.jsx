    ...
    <Container>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto">
          <Nav.Link to="/Principal" href="/" className="navbar-link">Inicio</Nav.Link>
          <Nav.Link href="#conocenos" className="navbar-link">Categorias</Nav.Link>
          <Nav.Link href="#productos" className="navbar-link">Productos en promoción</Nav.Link>
          <Nav.Link href="#marcas" className="navbar-link">Marcas</Nav.Link>
          <Nav.Link href="#infor" className="navbar-link">Información sobre nosotros</Nav.Link>
        </Nav>
